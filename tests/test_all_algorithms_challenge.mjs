/**
 * test_all_algorithms_challenge.mjs
 * Comprehensive benchmarking harness for all search algorithms on Rip-Up & Reroute Challenge Circuit
 */
    ...
    while (true) {
        ...
        if (step.type === 'net_routed') {
            stepEvents.push({
                ...
                cost: step.cost,
                path: step.path.map(id => grid.toCoord(id))
            });
